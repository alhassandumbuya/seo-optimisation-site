SEO OPTIMIZATION SITE REFACTOR 

## Description 

The aim of this product is to refactor the exsiting code for the SEO optimization to make it more accessible. 
The clients need is that they want a codebase that follows accessibility standards, so that thier site is optimized for search engines. The acceptance criteria I want to complete for this projects are, Semantic HTML elements can be found throughout the source code;
